"""
Django settings for rest_site project.
...
SECRET_KEY = 'django-insecure-8*&bsx6d93zh!rjx5vcoxi&f1*ybo&^obzz7kf1rp7*av@9fz8'
...
REST_FRAMEWORK = {
    ...
    # Pagination
    # Provides a list of pagination classes to be used for pagination.
